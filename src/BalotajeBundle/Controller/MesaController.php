...
//        );
        ...
        return $this->render('BalotajeBundle:Mesa:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $this->get('session')->getFlashBag()->add(
                'success', 'Mesa creado correctamente.'
            );

            return $this->redirect($this->generateUrl('mesas_show', array('id' => $entity->getId())));
        }

        return $this->render('BalotajeBundle:Mesa:new.html.twig', array(
            'entity' => $entity,
    ...
    {
        $form = $this->createForm(new MesaType(), $entity, array(
    ...
    public function showAction($id)
    {
        ...
        return $this->render('BalotajeBundle:Mesa:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BalotajeBundle:Mesa:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $this->get('session')->getFlashBag()->add(
                'success', 'Mesa actualizado correctamente.'
            );
